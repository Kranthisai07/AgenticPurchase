...
try:
    ABO_IMAGES = Path(__file__).resolve().parents[2] / "dataset" / "abo-images" / "small"
    if ABO_IMAGES.exists():
        app.mount("/abo-images", StaticFiles(directory=str(ABO_IMAGES)), name="abo_images")
except Exception:
    pass
